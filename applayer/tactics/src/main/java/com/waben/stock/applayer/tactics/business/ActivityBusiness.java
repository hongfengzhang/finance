...
public class ActivityBusiness {
	...
	@Autowired
	@Qualifier("activityPublisherInterface")
	...
	public ActivityDto findActivityById(long activityId) {
		...
		List<ActivityPublisherDto> activityPublisherDtos = activityPublisherReference
				.getActivityPublishersByActivityId(activityId).getResult();
		...
		for (ActivityPublisherDto activityPublisherDto : activityPublisherDtos) {
			...
			// 抵扣券
			Response<List<PublisherDeduTicketDto>> publisherDeduTickets = publisherDeduTicketReference
					.getPublisherDeduTicketsByApId(apId);
			...
			// 话费
			Response<List<PublisherTeleChargeDto>> publisherTeleCharges = publisherTeleChargeReference
					.getPublisherTeleChargesByApId(apId);
			...
			// 实物
			Response<List<PublisherTicketDto>> publisherTickets = publisherTicketReference
					.getPublisherTicketsByApId(apId);
