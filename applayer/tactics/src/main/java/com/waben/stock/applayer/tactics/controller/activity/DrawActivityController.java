...
public class DrawActivityController {
    ...
    @ApiImplicitParams({ @ApiImplicitParam(paramType = "path", dataType = "long", name = "activityId", value = "活动id", required = true),@ApiImplicitParam(paramType = "path", dataType = "long", name = "publisherId", value = "发布人id", required = true) })
