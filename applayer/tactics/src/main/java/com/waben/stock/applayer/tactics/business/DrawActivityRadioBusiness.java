...
public class DrawActivityRadioBusiness {
	...
	@Autowired
	@Qualifier("drawActivityRadioInterface")
	...
	public List<DrawActivityRadioDto> getDrawActivityRadiosByActivityId(long activityId) {
		Response<List<DrawActivityRadioDto>> response = drawActivityRadioReference
				.getDrawActivityRadiosByActivityId(activityId);
