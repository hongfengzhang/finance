...
public class BatchPayWSSoapBindingSkeleton implements BatchPay, org.apache.axis.wsdl.Skeleton {
    private com.waben.stock.applayer.tactics.payapi.fastmoney.utils.BatchPayWS.BatchPay impl;
    ...
    */
    ...
    public BatchPayWSSoapBindingSkeleton() {
        this.impl = (BatchPay) new BatchPayWSSoapBindingImpl();
    }

    public BatchPayWSSoapBindingSkeleton(com.waben.stock.applayer.tactics.payapi.fastmoney.utils.BatchPayWS.BatchPay impl) {
        this.impl = impl;
    }
