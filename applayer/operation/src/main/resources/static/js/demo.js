...
demo = {
	...
	showSwal: function(type,text,text1){
    	if(type == 'basic'){
        	swal("Here's a message!");

    	}else if(type == 'title-and-text'){
        	swal("银行卡信息", "It's pretty, isn't it?")
...
//					});
        	...
        	swal({  title: 'HTML example',
                    html:
                        text+'You can use <b>bold text</b>, ' +
