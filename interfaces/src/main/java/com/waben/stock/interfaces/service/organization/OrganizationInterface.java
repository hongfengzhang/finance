...
public interface OrganizationInterface {
	...
	Response<OrganizationDto> addition(OrganizationForm orgForm);
	...
	List<TreeNode> adminTree(Long orgId);
	...
	Response<List<OrganizationDto>> listByParentId(Long parentId);
	...
	Response<OrganizationDetailDto> detail(Long orgId);
	...
	Response<OrganizationDto> modifyName(Long id, String name);
