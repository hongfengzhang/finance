...
public interface BuyRecordInterface {
     ...
     * @param investorId     投资人ID
     * @param id             点买记录id
     * @param delegateNumber 委托编号，证券账号购买股票后的交易编号
     * @param buyingPrice    买入价格
     * @param numberOfStrand 持股数
     * @return 点买记录
     */
     ...
     * @param profitDistributionRatio 盈利分配比例
     * @return 点买记录
     */
