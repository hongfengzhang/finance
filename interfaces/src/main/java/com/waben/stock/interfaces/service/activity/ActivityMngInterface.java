 ...
 * 
 * 
 * @author guowei 2018/4/10 update zengzhiwei 2018/4/11
 */
@FeignClient(name = "activity", path = "activity", qualifier = "activityMngInterface")
public interface ActivityMngInterface {
	...
	Response<PageInfo<ActivityDto>> getActivityList(@RequestParam(value = "pageno") int pageno,
