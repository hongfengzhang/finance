 ...
 * @desc
 */
@FeignClient(name = "manage", path = "role", qualifier = "roleInterface")
public interface RoleInterface {
	...
	Response<RoleDto> bindAdminRoleWithPermissionAndMenu(@PathVariable("id") Long id,
			@PathVariable("variety") Long variety);
