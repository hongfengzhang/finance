...
public class CapitalAccountService {
	...
	public Page<CapitalAccountAdminDto> adminPagesByQuery(CapitalAccountAdminQuery query) {
		...
		String sql = String
				.format("select t1.id, t2.id as publisher_id, t3.name, t2.phone, t1.frozen_capital, t1.available_balance, t1.update_time, t2.create_time, t1.state, IFNULL(t4.recharge, 0), IFNULL(t5.withdraw, 0) from capital_account t1 "
		...
		setMethodMap.put(new Integer(4), new MethodDesc("setFrozenCapital", new Class<?>[] { BigDecimal.class }));
		setMethodMap.put(new Integer(5), new MethodDesc("setAvailableBalance", new Class<?>[] { BigDecimal.class }));
		setMethodMap.put(new Integer(6), new MethodDesc("setUpdateTime", new Class<?>[] { Date.class }));
		setMethodMap.put(new Integer(7), new MethodDesc("setRegistTime", new Class<?>[] { Date.class }));
		setMethodMap.put(new Integer(8), new MethodDesc("setState", new Class<?>[] { Integer.class }));
		setMethodMap.put(new Integer(9), new MethodDesc("setTotalRecharge", new Class<?>[] { BigDecimal.class }));
		setMethodMap.put(new Integer(10), new MethodDesc("setTotalWithdraw", new Class<?>[] { BigDecimal.class }));
