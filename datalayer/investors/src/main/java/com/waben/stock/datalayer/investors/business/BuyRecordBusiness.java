...
public class BuyRecordBusiness {
	 ...
	 */
	public BuyRecordDto buyRecordApplyBuyIn(Investor investor, SecuritiesStockEntrust securitiesStockEntrust,
			String entrust) {
		// securitiesStockEntrust.setEntrustNumber(entrust);
		Response<BuyRecordDto> response = buyRecordReference.buyLock(investor.getId(),
				securitiesStockEntrust.getBuyRecordId(), entrust);
	 ...
	 * @return
	 */
	public BuyRecordDto entrustApplySellOut(Investor investor, SecuritiesStockEntrust securitiesStockEntrust,
			String entrust, String windControlType) {
		// securitiesStockEntrust.setEntrustNumber(entrust);
		// 卖出锁定
		logger.info("id:{},bId:{},entrust:{},w:{}", investor.getId(), securitiesStockEntrust.getBuyRecordId(), entrust,
				windControlType);
		Response<BuyRecordDto> response = buyRecordReference.sellLock(investor.getId(),
				securitiesStockEntrust.getBuyRecordId(), entrust, windControlType);
