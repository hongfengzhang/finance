...
import com.waben.stock.datalayer.investors.reference.fallback.StockReferenceFallback;
 ...
 * @desc
 */
@FeignClient(name = "stockcontent", path = "stock", fallback = StockReferenceFallback.class, qualifier = "stockFeignReference")
